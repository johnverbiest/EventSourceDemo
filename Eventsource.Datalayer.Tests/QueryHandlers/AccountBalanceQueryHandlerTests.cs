...
public class AccountBalanceQueryHandlerTests
{
    ...
    [Theory, UnitTest]
    public async Task AccountBalanceQueryHandler_Should_ProcessOutgoingTransferToOtherFund([Frozen] IEventStore store, int accountNumber, FundsDepositedEvent event1, FundsDepositedEvent event2, FundsTransferedEvent event3, AccountBalanceQuery query, AccountBalanceQueryHandler sut)
    {
        // Arrange
        event1.AccountNumber = accountNumber + 2;
        event2.AccountNumber = accountNumber;
    ...
    [Theory, UnitTest]
    public async Task AccountBalanceQueryHandler_Should_ProcessIncomingTransferFromOtherFund([Frozen] IEventStore store, int accountNumber, FundsDepositedEvent event1, FundsDepositedEvent event2, FundsTransferedEvent event3, AccountBalanceQuery query, AccountBalanceQueryHandler sut)
    {
        // Arrange
        event1.AccountNumber = accountNumber + 2;
        event2.AccountNumber = accountNumber;
        event3.AccountNumber = accountNumber + 2;
        event3.DestinationAccountNumber = accountNumber;
        query.AccountNumber = accountNumber;
    ...
    [Theory, UnitTest]
    public async Task AccountBalanceQueryHandler_Should_ProcessTransferToSelfCorrectly([Frozen] IEventStore store, int accountNumber, FundsDepositedEvent event1, FundsDepositedEvent event2, FundsTransferedEvent event3, AccountBalanceQuery query, AccountBalanceQueryHandler sut)
    {
        // Arrange
        event1.AccountNumber = accountNumber + 2;
        event2.AccountNumber = accountNumber;
